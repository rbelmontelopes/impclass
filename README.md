...
The pipeline was build on Ubuntu 22.04 and nextflow 24.04.4, and also tested in Ubuntu 26 with nextflow 26.04.06, and is expected to work in other Unix based systems, but is unsure if it will work on windows based machines.
